...
public class Score extends JFrame implements ActionListener{
    ...
    Score(String username, int score){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("simple/minds/icons/score_logo.png"));
        ...
        try{  
            ...
            stmt.executeUpdate("INSERT INTO marks (username,score) VALUES ('"+username+"',"+score+");");
