...
public class ViewUsers extends javax.swing.JFrame {
        ...
        DefaultTableModel model1= (DefaultTableModel)table.getModel();
         ...
         try{  
            ...
            {         
                ...
                model1.insertRow(0, new Object[] { rs.getString(1),rs.getString(4),rs.getString(2)});
                i++;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int usrid=Integer.parseInt(uid.getText());
        try
        {
            Class.forName("com.mysql.jdbc.Driver");  
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/quizz_app","root","");  
            ...
            stmt.executeUpdate("DELETE FROM login where id="+usrid+";");
            this.setVisible(false);
